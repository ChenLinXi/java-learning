package com.jason.zookeeper.Curator.impl;

import com.jason.zookeeper.Curator.LockZookeeperClient;
...
public class LockZookeeperClientFactory implements LockZookeeperClient {
    ...
    public void setHacGC(boolean hacGC) {
        this.hacGC = hacGC;
    }
    ...
    public void gc(String gcPath) {
        if (hacGC && StringUtils.isNotBlank(gcPath)) {
